locals {
  ...
  region_regex    = "(us-east-[1-2])|(us-west-[1-2])|(af-south-1)|(ap-east-1)|(ap-southeast-[1-3])|(ap-northeast-[1-3])|(ap-south-1)|(ca-central-1)|(eu-central-1)|(eu-west-[1-3])|(eu-south-1)|(eu-north-1)|(me-south-1)|(sa-east-1)"
}
